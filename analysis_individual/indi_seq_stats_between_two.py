...
# between each two populations
# here not including the category: others
# syllable
print('common syllables of BJ and LT')
syl_comm_three_list_5_BJ_LT = all_syl_num_dict_list[0].keys() & all_syl_num_dict_list[1].keys()
# print(syl_comm_three_list_5)
common_syl_list = []
for syl_dict in all_syl_num_dict_list[0:-1]:
	common_syl_num = []
	for syl in syl_comm_three_list_5_BJ_LT:
		common_syl_num.append(syl_dict[syl])
	common_syl_list.append(common_syl_num)

# print(common_syl_list)
syl_BJ_LT_stats = stats.chi2_contingency(common_syl_list)
print(syl_BJ_LT_stats[0], syl_BJ_LT_stats[1])

print('common syllables of BJ and JA')
syl_comm_three_list_5_BJ_JA = all_syl_num_dict_list[0].keys() & all_syl_num_dict_list[2].keys()
# print(syl_comm_three_list_5)
common_syl_list = []
for syl_dict in [all_syl_num_dict_list[0], all_syl_num_dict_list[2]]:
	common_syl_num = []
	for syl in syl_comm_three_list_5_BJ_JA:
		common_syl_num.append(syl_dict[syl])
	common_syl_list.append(common_syl_num)

# print(common_syl_list)
syl_BJ_JA_stats = stats.chi2_contingency(common_syl_list)
print(syl_BJ_JA_stats[0], syl_BJ_JA_stats[1])

print('common syllables of LT and JA')
syl_comm_three_list_5_LT_JA = all_syl_num_dict_list[1].keys() & all_syl_num_dict_list[2].keys()
# print(syl_comm_three_list_5)
common_syl_list = []
for syl_dict in all_syl_num_dict_list[1:]:
	common_syl_num = []
	for syl in syl_comm_three_list_5_LT_JA:
		common_syl_num.append(syl_dict[syl])
	common_syl_list.append(common_syl_num)

# print(common_syl_list)
syl_LT_JA_stats = stats.chi2_contingency(common_syl_list)
print(syl_LT_JA_stats[0], syl_LT_JA_stats[1])


# transitions
print('common transitions of BJ and LT')
tran_comm_three_list_5 = all_tran_num_dict_list[0].keys() & all_tran_num_dict_list[1].keys()
# print(tran_comm_three_list_5)
common_tran_list = []
for tran_dict in all_tran_num_dict_list[0:-1]:
	common_tran_num = []
...
print('common transitions of BJ and JA')
tran_comm_three_list_5 = all_tran_num_dict_list[0].keys() & all_tran_num_dict_list[2].keys()
# print(tran_comm_three_list_5)
common_tran_list = []
for tran_dict in [all_tran_num_dict_list[0], all_tran_num_dict_list[2]]:
	common_tran_num = []
	for tran in tran_comm_three_list_5:
		common_tran_num.append(tran_dict[tran])
	common_tran_list.append(common_tran_num)
...
print('common transitions of LT and JA')
tran_comm_three_list_5 = all_tran_num_dict_list[1].keys() & all_tran_num_dict_list[2].keys()
# print(tran_comm_three_list_5)
common_tran_list = []
for tran_dict in all_tran_num_dict_list[1:]:
	common_tran_num = []
	for tran in tran_comm_three_list_5:
		common_tran_num.append(tran_dict[tran])
	common_tran_list.append(common_tran_num)
...
# positions
print('common positions of BJ and LT')
for x in range(4):
	print('positions'+str(x))
	po_common_syl_list = all_po_num_dict_list[0][x].keys() & all_po_num_dict_list[1][x].keys()


	common_po_list = []
	for po_dict in all_po_num_dict_list[0:-1]:
		common_po_num = []
...
print('common positions of BJ and JA')
for x in range(4):
	print('positions'+str(x))
	po_common_syl_list = all_po_num_dict_list[0][x].keys() & all_po_num_dict_list[2][x].keys()


	common_po_list = []
	for po_dict in [all_po_num_dict_list[0], all_po_num_dict_list[2]]:
		common_po_num = []
		for po in po_common_syl_list:
			common_po_num.append(po_dict[x][po])
		common_po_list.append(common_po_num)
...
print('common positions of LT and JA')
for x in range(4):
	print('positions'+str(x))
	po_common_syl_list = all_po_num_dict_list[1][x].keys() & all_po_num_dict_list[2][x].keys()


	common_po_list = []
	for po_dict in all_po_num_dict_list[1:]:
		common_po_num = []
		for po in po_common_syl_list:
			common_po_num.append(po_dict[x][po])
		common_po_list.append(common_po_num)
...
# sequence
print('common sequences of BJ and LT')
seq_comm_three_list_5 = all_seq_num_dict_list[0].keys() & all_seq_num_dict_list[1].keys()
# print(seq_comm_three_list_5)
common_seq_list = []
for seq_dict in all_seq_num_dict_list[0:-1]:
	common_seq_num = []
...
print('common sequences of BJ and JA')
seq_comm_three_list_5 = all_seq_num_dict_list[0].keys() & all_seq_num_dict_list[2].keys()
# print(seq_comm_three_list_5)
common_seq_list = []
for seq_dict in [all_seq_num_dict_list[0], all_seq_num_dict_list[2]]:
	common_seq_num = []
	for seq in seq_comm_three_list_5:
		common_seq_num.append(seq_dict[seq])
	common_seq_list.append(common_seq_num)
...
print('common sequences of LT and JA')
seq_comm_three_list_5 = all_seq_num_dict_list[1].keys() & all_seq_num_dict_list[2].keys()
# print(seq_comm_three_list_5)
common_seq_list = []
for seq_dict in all_seq_num_dict_list[1:]:
	common_seq_num = []
	for seq in seq_comm_three_list_5:
		common_seq_num.append(seq_dict[seq])
	common_seq_list.append(common_seq_num)
